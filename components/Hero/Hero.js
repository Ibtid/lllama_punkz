        ...
        if (contextStore.account) {
            (async function () {
                ...
                const contractAddress =
                    "0x262BeE6504cc30DB0A19f6Bea177EAD8C0d139a4";
                const apiKey = "QDBHHN1J4AZUYDCNR6G7U9U2CJ23FMM2T2";
                let result = await axios.get(
                    `https://api.polygonscan.com/api?module=account&action=tokenbalance&contractaddress=${contractAddress}&address=${contextStore.account}&tag=latest&apikey=${apiKey}`
                );
