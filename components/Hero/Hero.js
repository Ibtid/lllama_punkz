    ...
    <div className="bg-[url('../public/assests/images/background.png')] content_bg font-Roboto">
      <div className='flex justify-evenly pt-16'>
        ...
        {!contextStore.account && (
          <div
            ...
            {staticData.connectWallet[contextStore.currentLanguage.language]}
          </div>
        )}
        {contextStore.account && (
          <div
            ...
            {staticData.walletConnected[contextStore.currentLanguage.language]}
          </div>
        )}
      </div>
      <div className='text-lightGreen w-full flex flex-col items-center transition-all mt-16 mb-8 md:mb-0'>
        <div className='text-lightGreen w-full flex justify-center items-center'>
          {staticData.beCareful[contextStore.currentLanguage.language]}
        </div>
